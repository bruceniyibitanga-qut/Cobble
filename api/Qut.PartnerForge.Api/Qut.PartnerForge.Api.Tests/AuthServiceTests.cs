...
using Qut.PartnerForge.Api.Services;
...
public class AuthServiceTests
{
    ...
    public AuthServiceTests()
    {
        ...
        var config = new ConfigurationBuilder().AddInMemoryCollection(new Dictionary<string, string?>
        {
            ...
            ["Jwt:Issuer"] = "Qut.PartnerForge.ApiTest",
    ...
    public void GenerateJwtToken_CanBeValidatedWithConfiguredPublicKey()
    {
        ...
        var principal = handler.ValidateToken(token, new TokenValidationParameters
        {
            ...
            ValidIssuer = "Qut.PartnerForge.ApiTest",
    ...
    public void GenerateJwtToken_ExpiresInFuture()
    {
        ...
        Assert.Equal("Qut.PartnerForge.ApiTest", jwt.Issuer);
        ...
        Guid? organisationId = null)
    {
        return new User
        {
            ...
            Organisation = organisationId.HasValue
                ? new Organisation { Id = organisationId.Value, Name = "Test Organisation Inc." }
                : null
        };
    }
}
